...
Public Class SupprimerPatient1

    Dim mouse_move As System.Drawing.Point

    Private Sub supprimerpatient(ByVal cinc As String)
        ...
        Dim str As String
        str = String.Concat("DELETE FROM patients WHERE cin=", cinc)
    ...
    Private Sub oui_Click(sender As Object, e As EventArgs) Handles oui.Click
        supprimerpatient(cnxcin)
        MsgBox("Patient supprimé avec succès !", vbDefaultButton1, "Succès")
        Me.Close()
    End Sub
